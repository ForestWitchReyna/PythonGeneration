...
def transform(name: str, get_countries_fn, get_country_code_fn,
              get_country_currency_fn):
    countries = get_countries_fn()
    code = get_country_code_fn(countries, name)
    currency = get_country_currency_fn(countries, name)
...
def show_country_info():
    ...
    result = transform(name, get_countries, get_country_code, 
